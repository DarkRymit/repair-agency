...
insert into receipt_items (receipt_id,repair_work_id, price_amount, price_currency) values (2,3,11.10,'USD');
insert into receipt_items (receipt_id,repair_work_id, price_amount, price_currency) values (2,3,14.10,'USD');
