...
insert into app_currencies (code) values ('Non');

insert into app_locales(lang) values('en');
insert into app_locales(lang) values('uk');
insert into app_locales (lang) values ('Non');
...
insert into receipts (user_id,receipt_status_id,category_id,master_id,total_price, currency_id,note,creation_date, last_modified_by, last_modified_date,created_by) values (4,3,1,3,84.9,1,'Typical note','2022-01-10T14:23:22Z','test','2022-01-10T14:23:22Z','test');
insert into receipts (user_id,receipt_status_id,category_id,master_id,total_price, currency_id,note,creation_date, last_modified_by, last_modified_date,created_by) values (5,2,1,3,40.3,1,'Typical note','2021-12-14T16:00:40Z','test','2021-12-14T16:00:40Z','test');
insert into receipts (user_id,receipt_status_id,category_id,master_id,total_price, currency_id,note,creation_date, last_modified_by, last_modified_date,created_by) values (5,6,1,6,40.3,1,'Typical note','2021-10-14T17:00:40Z','test','2021-10-14T17:00:40Z','test');
insert into receipts (user_id,receipt_status_id,category_id,master_id,total_price, currency_id,note,creation_date, last_modified_by, last_modified_date,created_by) values (4,5,1,6,78.9,1,'Typical note','2022-02-10T17:34:31Z','test','2022-02-10T17:34:31Z','test');
