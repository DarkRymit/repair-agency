...
insert into receipts (user_id,receipt_status_id,category_id,master_id,price_amount, price_currency,note,creation_date) values (4,3,1,3,84.9,'USD','Typical note','2022-01-10T14:23:22Z');
insert into receipts (user_id,receipt_status_id,category_id,master_id,price_amount, price_currency,note,creation_date) values (5,2,1,3,40.3,'USD','Typical note','2021-12-14T16:00:40Z');
insert into receipts (user_id,receipt_status_id,category_id,master_id,price_amount, price_currency,note,creation_date) values (5,6,1,6,40.3,'USD','Typical note','2021-10-14T17:00:40Z');
insert into receipts (user_id,receipt_status_id,category_id,master_id,price_amount, price_currency,note,creation_date) values (4,5,1,6,78.9,'USD','Typical note','2022-02-10T17:34:31Z');
